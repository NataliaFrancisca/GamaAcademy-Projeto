...
//Se a resposta for sim, mostrar os idiomas disponíveis
...
const entradaInicial = readLine.question('Deseja buscar musicas pelo idioma? S/N ');


if(entradaInicial.toLocaleUpperCase() === 'S'){

	console.log('\n')
	console.log('Esses são os idiomas disponiveis: ', 'Portugues ', 'Ingles ', 'Frances ', 'Italiano ', 'Coreano' ,'\n')
